...
function agregarCliente($nombre, $depto, $sexo, $edad, $dinero)
{
	$conexion = new conexion("localhost","clientes","root", "");
	$query="insert into clientes(nombre, departamento, sexo, edad, efectivo) values('".$nombre."','".$depto."','".$sexo."',".$edad.",".$dinero.")";
